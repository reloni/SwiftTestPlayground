...
func sortDescriptor<Value, Property>(property: @escaping (Value) -> Property, comparator: @escaping (Property, Property) -> Bool) -> SortDescriptor<Value> where Property: Comparable {
	return { value1, value2 in
		return comparator(property(value1), property(value2))
	}
}
...
let yearOfBirth: SortDescriptor<Person> = sortDescriptor(property: { $0.yearOfBirth }, comparator: <)
